...
local globalkeys = gears.table.join(
	...
	end, { description = "swap prev monitor", group = "client" }),

	awful.key({ modkey, ctrlkey }, "l", function()
		awful.screen.focus_relative("1")
	end, { description = "swap next monitor", group = "client" }),
	...
	awful.key({ modkey }, "space", function()
		spawn(rofi_dir .. "scripts/launcher_t1")
	end, { description = "launch rofi", group = "launcher" }),
	awful.key({}, "XF86Calculator", function()
		spawn("gnome-calculator")
	end, { decription = "launch calculator", group = "launcer" }),

	awful.key({ modkey, altkey }, "b", function()
		spawn(rofi_dir .. "/browser/browser_menu.pl")
	...
	awful.key({ ctrlkey }, "Print", function()
		spawn.with_shell("flameshot screen -p ~/Pictures")
